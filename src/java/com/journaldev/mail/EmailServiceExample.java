...
public class EmailServiceExample {
	 ...
	 * @param port The Port
	 */
	public EmailServiceExample(String user, String pass, String host, String port) {
		this.user = user;
		this.pass = pass;
	...
	public static void main(String[] args) {
		...
		EmailServiceExample emailService = new EmailServiceExample("noreplayequipo4@gmail.com", "abcd*1234", null,null);
		try {
