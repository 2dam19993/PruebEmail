 ...
 */
public class EmailServiceExample1 {
	 ...
	 * @param port The Port
	 */
	public EmailServiceExample1(String user, String pass, String host, String port) {
		this.user = user;
		this.pass = pass;
	...
	public static void main(String[] args) {
		...
		EmailServiceExample1 emailService = new EmailServiceExample1("noreplayequipo4@gmail.com", "abcd*1234", null,null);
		try {
